...
- **Section-total P&L imported (2026-05-11):** Paramount's GL codes don't map 1:1 to FM's COA, so the import collapses Paramount's section totals (NET RENT INCOME / TOTAL REIMBURSEMENT / TOTAL OTHER / TOTAL OPEX / G&A / DEBT SERVICE / TI & CAP-EX) into single FM GL codes:
  - NET RENT INCOME → 4010 (Base Rent - Contractual): annual $15.998M, YTD Jan-Apr $5.269M
  - TOTAL REIMBURSEMENT INCOME → 4110 (Estimated CAM Charges): annual $1.022M, YTD $0.348M
  - TOTAL OTHER INCOME → 4700 (Miscellaneous Income): annual $63K, YTD $18K
  - TOTAL OPERATING EXPENSES → 5497 (Interior R&M, used as the bucket placeholder; includes Paramount Recoverable + Direct Recoverable + One-Time Unusual): annual $6.699M, YTD $2.025M
  - G&A EXPENSES → 7064 (Professional Fees): annual $139K, YTD $49K
  - TENANT COST & CAP-EX → 7105 (Tenant Improvements): annual $500K, YTD $1.509M (TI front-loaded — Smolin / NVA / Inflexion all hit in Q1)
  - TOTAL DEBT SERVICE → 7152 (1st Mortgage Interest): annual $6.605M, YTD $2.210M
- **Math reconciles:** Total Revenue annual = $17.083M, NOI annual = $10.384M, after-debt net = $3.141M — all match Paramount's bottom-line "NET OPERATIONS" row exactly. NOI margin ~60.8%.
- **How it's split:** Annual Budget = annual ÷ 12 per month (flat — no seasonality applied). Actuals = YTD ÷ 4 per month for Jan-Apr 2026; May-Dec stay $0 until next Paramount package. Import script: `outputs/import_rb_pl.py`.
- **Detailed GL-level financial data NOT imported.** This is a section-total only view. When First Mile wants line-item detail for River Center, we'll need a Paramount → FM COA translation layer.
